...
class SmartSearch(models.Model):
    ...
    def query_with_params(self, question, *args, **kwargs):
        ...
        print("DDDDDDDDDDDDD", list_of_ids)
        return list_of_ids
    ...
    def convert_string(self, sql_string):
        ...
        sql_resul = f"SELECT id, {select_part} FROM product_template WHERE {where_part} LIMIT 24"

        print("SELECT_PART", select_part)
        print("WHERE_PART", where_part)
        print("SQL_RESUL", sql_resul)
        return sql_resul
