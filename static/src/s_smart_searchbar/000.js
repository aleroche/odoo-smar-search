...
import {Markup} from 'web.utils';
    ...
    publicWidget.registry.searchSmartBar = publicWidget.Widget.extend({
    selector: '.s_smart_searchbar .o_searchbar_form',
    events: {
        'input .smart-search-query': '_onInput',
        'focusout': '_onFocusOut',
        'keydown .smart-search-query, .dropdown-item': '_onKeydown',
        'search .smart-search-query': '_onSearch',
    },
     ...
     */
    start: function () {
        console.log("SMART_SEARCH_COMPONENT_KRAMER")
        this.$input = this.$('.smart-search-query');
    ...
    async _fetch() {
        const res = await this._rpc({
            route: '/website/snippet/smart-search',
            params: {
...
export default {
    searchSmartBar: publicWidget.registry.searchSmartBar,
};
